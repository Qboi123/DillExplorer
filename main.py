...
from dillreader import DillFile
...
class MainFrame(wx.Frame):
    def __init__(self):
        ...
        self.data = {}
        self.path = None
        self.SetTitle(f"Dill Explorer {VERSION}")
    ...
    def saveas_command(self, evt: wx.CommandEvent):
        with wx.FileDialog(self, "Save Dill File As..", wildcard="Dill Data files (*.dill)|*.dill",
    ...
    def open_command(self, evt: wx.CommandEvent):
        ...
        with wx.FileDialog(self, "Select Dill File", wildcard="Dill Data files (*.dill)|*.dill",
